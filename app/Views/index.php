...
<body data-spy="scroll" data-target="#main-navbar">
    ...
    <div class="body">
            ...
            <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <img src="../assets/img/dumi/dumi_logo_white.png" alt="dumi" height="50px" width="85px"
        ...
        <section id="text-carousel-intro-section" class="parallax" data-stellar-background-ratio="0.5"
            style="background-image: url(../assets/img/dumi/header_web.png);">
                        ...
                        <div class="col-sm-6">
                            <div class="contact-info">
                                ...
                                <ul class="contact-address">
                                    <li><i class="fa fa-map-marker fa-lg"></i>&nbsp; 100 Limpbiscayne Blvd. (North) 17st
                                        Floor ,<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; New World Tower New
                                        York ,<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; New York, USA, 33148
                                    </li>
