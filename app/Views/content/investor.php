    ...
    <section id="about-lembaga" class="about-lembaga section-padding">
        <div class="container">
            ...
            <div class="section-title-header text-left" style="padding-bottom:0;font-size:15px">
                ...
                <a href="../assets/dokumen/Akta-PT-Fidac-Inovasi-Teknologi-Tbk..pdf"><i class="fa-solid fa-file-lines fa-2xl" style="color: #949494;font-size:120px;;margin-top:10px"></i>
                </a>
...
<body>
    ...
    <section id="about-lembaga" class="about-lembaga section-padding">
        <div class="container">
            ...
            <div class="section-title-header text-left" style="padding-bottom:0;font-size:15px">
                <h4 class="title-lembaga wow fadeInUp" data-wow-delay="0.2s">Akta Perusahaan</h4>
                <a href="../assets/dokumen/Akta-PT-Fidac-Inovasi-Teknologi-Tbk..pdf"><i class="fa-solid fa-file-lines" style="color: #949494;font-size:120px;;margin-top:10px"></i>
                </a>
                
                <a href="../assets/dokumen/Akta-PT-Fidac-Inovasi-Teknologi-Tbk..pdf">Akta Perusahaan
                </a>
